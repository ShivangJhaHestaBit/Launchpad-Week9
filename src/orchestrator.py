...
from tools.file_executor import file_agent
...
6. Agent responsibilities:
   ...
   - code → perform Python analysis using prior outputs. 
...
db = db_agent(name="DB_AGENT",model_client=model_client,db_path="src/sales.db")
